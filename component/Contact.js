            ...
            >
                <div className="bg-white/80 backdrop-blur-sm p-4 sm:p-8 md:p-12 lg:p-16 rounded-xl shadow-md w-full max-w-6xl">
                    ...
                    <div className="flex flex-col items-center justify-center w-full">
                        <form ref={form} onSubmit={handleSubmit} className="w-full max-w-2xl space-y-4">
                            <div>
                                <label htmlFor="from_name" className="block text-sm font-medium text-gray-800 mb-1">
                                    Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="from_email" className="block text-sm font-medium text-gray-800 mb-1">
                                    Email
                                </label>
                                <input
                                    type="email"
